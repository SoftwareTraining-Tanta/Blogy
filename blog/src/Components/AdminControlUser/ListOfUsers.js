                                        ...
                                        return (
                                            <div class="card m-5" style={{ width: '20rem', height: 'max-content' }}>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <NavLink to="/contact" className="btn text-light bg-primary me-2">Send E-mail</NavLink>
                                                    <button onClick={() => deleteUser(i.username)} className="btn btn-danger">Remove user</button>
                                                </div>
                                            </div>
                                        )
                                    })}
